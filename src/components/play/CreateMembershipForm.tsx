...
export function CreateMembershipForm({ coachId }: CreateMembershipFormProps) {
  ...
  return (
    <motion.div
      ...
      className={`rounded-lg shadow-md p-8 ${darkMode ? 'bg-gray-800' : 'bg-white'}`}
    >
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          <Star className="h-16 w-16 text-purple-500 mx-auto mb-4" />
          <h2 className={`text-2xl font-bold mb-2 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Create Membership</h2>
